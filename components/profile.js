        ...
        return(
            <ScrollView style={{backgroundColor:'white', height:'100%', top:'12%'}}>
                ...
                <View style={{
                    ...
                    <Text style={{fontSize:20, color:'black', marginLeft:'10%', fontWeight:'900',fontFamily:'Montserrat-Regular'}}>General</Text>
        ...
        return(
            <ScrollView>
                <View style={{
                    ...
                    <Text style={{fontSize:20, color:'black', marginLeft:'10%', fontWeight:'900',fontFamily:'Montserrat-Regular'}}>My Falcon</Text>
                    </View>
                <TouchableOpacity style={styles.sellerMode_1} onPress={() => navigation.navigate("WritingTranslation")}>
                ...
                <TouchableOpacity style={styles.sellerMode_1} onPress={() => navigation.navigate('GigSeller')}>
                        <Text style={styles.sellerMode_Text}> Share Gigs </Text>
                        <Icon name='chevron-right' style={styles.sellerMode_Icon}/>
                </TouchableOpacity>
                <TouchableOpacity style={styles.sellerMode_1}>
                        <Text style={styles.sellerMode_Text}> Manage Gigs </Text>
                        <Icon name='chevron-right' style={styles.sellerMode_Icon}/>
                </TouchableOpacity>
