    ...
    return(
        ...
        <View style={styles.notification}>
            <View style={styles.today}>
                <Text style={styles.todayText}>Notifications</Text>
            </View>
            <Divider orientation="vertical" width={5} />
            <View style={styles.today}>
                <Text style={styles.todayText}>Security</Text>
            </View>
            <Divider orientation="vertical" width={5} />
            <View style={styles.today}>
                <Text style={styles.todayText}>Terms of Services</Text>
            </View>
            <Divider orientation="vertical" width={5} />
            <View style={styles.today}>
                <Text style={styles.todayText}>Privacy policy</Text>
            </View>
            <Divider orientation="vertical" width={5} />
            <TouchableOpacity>
            <View style={styles.today}>
